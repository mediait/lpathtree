...
SELECT subpath('Top/Child1/Child2'::lpathtree,1,2);
SELECT subpath('Top/Child1/Child2'::lpathtree,-1,1);
SELECT subpath('Top/Child1/Child2'::lpathtree,0,-2);
SELECT subpath('Top/Child1/Child2'::lpathtree,0,-1);
SELECT subpath('Top/Child1/Child2'::lpathtree,0,0);
SELECT subpath('Top/Child1/Child2'::lpathtree,1,0);
SELECT subpath('Top/Child1/Child2'::lpathtree,0);
SELECT subpath('Top/Child1/Child2'::lpathtree,1);


SELECT index('1/2/3/4/5/6'::lpathtree,'1/2');
SELECT index('a/1/2/3/4/5/6'::lpathtree,'1/2');
SELECT index('a/1/2/3/4/5/6'::lpathtree,'1/2/3');
SELECT index('a/1/2/3/4/5/6'::lpathtree,'1/2/3/j');
SELECT index('a/1/2/3/4/5/6'::lpathtree,'1/2/3/j/4/5/5/5/5/5/5');
SELECT index('a/1/2/3/4/5/6'::lpathtree,'1/2/3');
SELECT index('a/1/2/3/4/5/6'::lpathtree,'6');
SELECT index('a/1/2/3/4/5/6'::lpathtree,'6/1');
SELECT index('a/1/2/3/4/5/6'::lpathtree,'5/6');
SELECT index('0/1/2/3/5/4/5/6'::lpathtree,'5/6');
SELECT index('0/1/2/3/5/4/5/6/8/5/6/8'::lpathtree,'5/6',3);
SELECT index('0/1/2/3/5/4/5/6/8/5/6/8'::lpathtree,'5/6',6);
SELECT index('0/1/2/3/5/4/5/6/8/5/6/8'::lpathtree,'5/6',7);
SELECT index('0/1/2/3/5/4/5/6/8/5/6/8'::lpathtree,'5/6',-7);
SELECT index('0/1/2/3/5/4/5/6/8/5/6/8'::lpathtree,'5/6',-4);
SELECT index('0/1/2/3/5/4/5/6/8/5/6/8'::lpathtree,'5/6',-3);
SELECT index('0/1/2/3/5/4/5/6/8/5/6/8'::lpathtree,'5/6',-2);
SELECT index('0/1/2/3/5/4/5/6/8/5/6/8'::lpathtree,'5/6',-20000);
...
SELECT lca('{la/2/3,1/2/3/4/5/6,""}'::lpathtree[]) IS NULL;
SELECT lca('{la/2/3,1/2/3/4/5/6}'::lpathtree[]) IS NULL;
SELECT lca('{1/la/2/3,1/2/3/4/5/6}'::lpathtree[]);
SELECT lca('{1/2/3,1/2/3/4/5/6}'::lpathtree[]);
SELECT lca('1/la/2/3'::lpathtree,'1/2/3/4/5/6'::lpathtree);
SELECT lca('1/2/3'::lpathtree,'1/2/3/4/5/6'::lpathtree);
SELECT lca('1/2/2/3'::lpathtree,'1/2/3/4/5/6'::lpathtree);
SELECT lca('1/2/2/3'::lpathtree,'1/2/3/4/5/6'::lpathtree,''::lpathtree);
SELECT lca('1/2/2/3'::lpathtree,'1/2/3/4/5/6'::lpathtree,'2'::lpathtree);
SELECT lca('1/2/2/3'::lpathtree,'1/2/3/4/5/6'::lpathtree,'1'::lpathtree);
...
SELECT nlevel('1/2/3/4'::lpathtree);
...
SELECT count(*) FROM _lpathtreetest WHERE t @> '1/1/1'::lpathtree ;
SELECT count(*) FROM _lpathtreetest WHERE t <@ '1/1/1'::lpathtree ;
